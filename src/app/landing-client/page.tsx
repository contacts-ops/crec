...
import MonCompteTemplateWrapper from '@/components/monCompteTemplate/MonCompteTemplateWrapper';
...
export const metadata: Metadata = {
  title: 'Mon compte – CREC Experts Comptables',
  description: "Espace client du site CREC Experts Comptables.",
};
  ...
  return (
    <div className="min-h-screen bg-background">
      <Suspense fallback={null}>
        <MonCompteTemplateWrapper {...{ "siteId": "e64668ea-2a54-4a8d-8fd0-0744e429c51a" }} />
