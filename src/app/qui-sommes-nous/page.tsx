...
import QuisommesnousTarifsWrapper from '@/components/quisommesnous-tarifs/QuisommesnousTarifsWrapper';
...
export default function QuiSommesNousPage() {
  return (
    ...
    <QuisommesnousTarifsWrapper {...{ "backgroundColor": "#FFFFFF", "stripeColor1": "#FFE5E5", "stripeColor2": "#FFFFFF", "rightBoxBackgroundColor": "#2D5F4F", "titleColor": "#FFD700", "textColor": "#FFFFFF", "fontFamily": "DM Sans", "titleFontFamily": "Playfair Display", "mediaUrl1": "", "mediaAlt1": "Traitement laser", "mediaType1": "image", "title": "Qui sommes-nous ?", "paragraph1": "Studio Laser Santé est un centre spécialisé dans l'épilation définitive. Fondé par une infirmière diplômée, nous utilisons la technologie avancée Alexandrite & Nd:YAG pour tous types de peaux avec une précision médicale.", "paragraph2": "Notre approche privilégie le bien-être de nos clients, un confort optimal et l'utilisation de la technologie de refroidissement cryogénique pour une expérience agréable et sécurisée. Venez profiter de l'excellence technique dans une atmosphère calme et apaisante." }} />
